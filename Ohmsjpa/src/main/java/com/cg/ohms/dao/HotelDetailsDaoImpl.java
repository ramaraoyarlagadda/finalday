...
public class HotelDetailsDaoImpl implements IHotelDetailsDao {
	 int check=0;
		...
		public HotelDetailsDTO viewDetails() throws HotelException {
			...
			System.out.println("----asdfkhasdjkf-------");
			EntityManagerFactory entityManagerFactory=Persistence.createEntityManagerFactory("abc");
			EntityManager entityManager= entityManagerFactory.createEntityManager();
			EntityTransaction entityTransaction = entityManager.getTransaction();
			System.out.println("jaion");
			entityTransaction.begin();
			
			HotelDetailsDTO hotelDetails=entityManager.find(HotelDetailsDTO.class, 4647);
			System.out.println("aklfhasdjkh");
	...
	public HotelDetailsDTO viewDetails(HotelDetailsDTO viewId) throws HotelException {
		HotelDetailsDTO hotelDetailsDTO=new HotelDetailsDTO();
		System.out.println("----asdfkhasdjkf-------");
		EntityManagerFactory entityManagerFactory=Persistence.createEntityManagerFactory("abc");
		EntityManager entityManager= entityManagerFactory.createEntityManager();
