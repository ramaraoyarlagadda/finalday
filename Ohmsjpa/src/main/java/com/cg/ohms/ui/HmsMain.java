...
//					hotelDetailsDTO.setHotelId(viewId);
					hotelDetailsDTO =hotel.viewHotelDetails();
				...
				case "4":
					...
					hotelDetailsDTO.setHotelId(deleteid);
